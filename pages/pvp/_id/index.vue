      ...
      meta: [
        {
          hid: 'og:title',
          name: 'og:title',
          content: this.island ? this.island.properties.name : 'Loading...'
        },
        {
          hid: 'og:image',
          name: 'og:image',
          content: this.island ? this.island.properties.imageOriginal : 'none'
        },
        {
          hid: 'og:description',
          name: 'og:description',
          content: this.island
            ? `
              ...
              Culture: ${this.island.properties.type.slice(0, 1).toUpperCase() +
                this.island.properties.type.slice(1)}
            `
            : 'N/A'
        },
        {
      ...
      link: [
        {
          ...
          href: this.island
            ? `${process.env.API_URL}/api/islands/${this.island.id}/oEmbed.json`
            : 'none'
        }
      ]
    };
